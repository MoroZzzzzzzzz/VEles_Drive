...
export const SimpleVehicleModal = ({ vehicle, open, onOpenChange, onContact, onFavorite, onCompare }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm">
      <div className="relative bg-gray-900 border border-gray-800 rounded-lg w-full max-w-4xl max-h-[95vh] overflow-y-auto m-4">
        {/* Close button */}
        <button 
          onClick={() => onOpenChange(false)}
          className="absolute top-4 right-4 z-10 p-2 bg-black/70 backdrop-blur-sm rounded-full text-white hover:bg-black/90 transition-colors"
        >
          <X className="h-5 w-5" />
        </button>
